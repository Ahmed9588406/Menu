...
import { Upload, Minus, Plus, Trash2, Link as LinkIcon } from "lucide-react";
...
export function ProductDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-5xl max-h-[90vh] overflow-y-auto bg-gray-50" dir="rtl">
        <DialogHeader className="bg-white px-6 py-4 -mx-6 -mt-6 border-b">
        ...
        <form id="product-form" onSubmit={handleSubmit} className="space-y-4 px-6">
              ...
              <div className="bg-white rounded-lg p-6 border">
                ...
                <div className="mt-4 grid grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input className="text-right bg-white" dir="rtl" />
                  </div>
                  <div className="space-y-2">
                    <Label className="text-right block text-slate-700">الاسم (English)</Label>
                    <Input className="text-left bg-white" dir="ltr" />
                  </div>
                </div>
                        ...
                        <div key={group.id} className="border rounded-lg p-4 space-y-3">
                          ...
                          <div className="grid grid-cols-2 gap-3">
                            <Input
                              ...
                              dir="rtl"
                            />
                            <Input placeholder="Group name (English)" className="text-left" dir="ltr" />
                          </div>
                          <div className="grid grid-cols-2 gap-3">
